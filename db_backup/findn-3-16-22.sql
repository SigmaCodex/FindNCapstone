...
(162267, 1, 'johndavedelgado', 'delgado', 'Male', '17/3/2022', '', 'hackmetry01@gmail.com', '09234456789', '');
...
(1, 'TNC', 'Pelaez Street and Sanciangko Street', '', '', '', '', '', ''),
(2, 'asd', 'asdas', '', '', '', '', '', ''),
(3, 'Voyager', 'sanciako street', '10.297973457508391,123.89774738088624', '', '', '', '0922377223', 'Voyager@gmail.com'),
(4, 'DUBLINS SHOP', 'Daanbantayan,Agujo', '11.267349129472876,124.01338226945677', '', '', '', '092333442', 'DUBLIMSHOP@gmail.com'),
(5, 'Shawn PRO shop', 'Guadalupe, Cebu City, Cebu City, Philippines', '10.321312931606187,123.88271034833417', '', '', '', '0977882334', 'ShawnPro@gmail.com');
...
(1422377, 'Delgado', 'John Dave ', '12/6/2000', 'Male', '', '', 'hackmetry01@gmail.com', 2147483647, '', '', '2nd Dose');
...
(101010, 'superadmin', 'superadmin123', 'superadmin', 'active'),
...
--
ALTER TABLE `computershop`
  MODIFY `shop_id` int(33) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
ALTER TABLE `compmanager`
  ...
  ADD CONSTRAINT `compmanager_ibfk_2` FOREIGN KEY (`shop_id_fk`) REFERENCES `computershop` (`shop_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
