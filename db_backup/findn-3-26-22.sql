...
(4, 7, 'VIP', 10, 25, 'CPU: Intel Core i5 - 8400 @ 2.80GHz (6 CPU\'s), ~2.8 GHz', '', 'Available', 20),
...
(2522356, 'selsaldo', 'ivan', '14/12/1999', 'Male', '', 'ivanatices@gmail.com', 2147483647, '', '', '1st Dose'),
(2522878, 'Delgado', 'John Dave', '12/6/2000', 'Male', '', 'hackmetry01@gmail.com', 2147483647, '', '', '1st Dose');
...
(2522356, 'student12345', '12345678', 'finder', 'Active'),
(2522405, 'ivan123', '12345678', 'Admin', 'Active'),
(2522878, 'dnko12345', '12345678', 'finder', 'Active');
...
--
ALTER TABLE `computer_type`
  MODIFY `Ctype_id` int(55) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `comp_booking`
--
ALTER TABLE `comp_booking`
  MODIFY `transaction_id` int(33) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2503787;
...
--
ALTER TABLE `transaction`
  MODIFY `transaction_id` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2503787;
