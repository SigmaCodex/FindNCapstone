...
(1022622, 7, 1622487, 2, '4/19/22'),
(1022625, 7, 1622487, 2, '4/19/22'),
(1022626, 7, 1622108, 2, '4/19/22'),
(1022627, 7, 1622108, 2, ''),
(1022628, 7, 1622487, 2, ''),
(1022629, 7, 1622487, 2, ''),
(1022630, 7, 1622163, 5, '');
...
(64, 1622108, 1604778, 'Pending', 'Booking Request To be accepted by the admin', '04/16/22', 'seen'),
...
--
ALTER TABLE `computer_ratings`
  MODIFY `rating_id` int(33) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1022635;
