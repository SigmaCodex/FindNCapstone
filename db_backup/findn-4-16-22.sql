...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 15, 2022 at 08:25 PM
...
(16223310, 7, 'Carlsan', 'Kim', 'Male', '13/4/2022', '', 'kim@gmail.com', '09233344566');
...
INSERT INTO `computershop` (`shop_id`, `shop_name`, `address`, `coordinates`, `operating_hours`, `net_speed`, `description`, `contact_number`, `email_address`, `Shop_Status`, `shop_img_icon`) VALUES
...
(1622108, 'Delgado', 'John Dave ', '2000-12-06', 'male', '', 'hackmetry01@gmail.com', '09262247240', 'dave.jpg', '1stvac'),
...
(64, 1622108, 1604778, 'Pending', 'Booking Request To be accepted by the admin', '04/16/22', 'unseen'),
(65, 16228210, 1604765, 'Pending', 'Booking Request To be accepted by the admin', '04/16/22', 'unseen'),
(66, 1622487, 1604846, 'Pending', 'Booking Request To be accepted by the admin', '04/16/22', 'unseen'),
(67, 1622163, 160473, 'Pending', 'Booking Request To be accepted by the admin', '04/16/22', 'unseen'),
...
--
ALTER TABLE `computer_ratings`
  MODIFY `rating_id` int(33) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1022621;
...
--
ALTER TABLE `finder_notification`
  MODIFY `finder_notif_id` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
...
--
ALTER TABLE `finder_notification`
  ADD CONSTRAINT `finder_notification_ibfk_1` FOREIGN KEY (`transaction_id`) REFERENCES `transaction` (`transaction_id`) ON DELETE NO ACTION ON UPDATE CASCADE,
