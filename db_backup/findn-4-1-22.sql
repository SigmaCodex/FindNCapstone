...
(5, 7, 'Regular', 204, 16, 'Cpu Intel Core i3 @3.60GHz(4 CPUs), ~ 3.6GHz GPU: N', '', 'Unavailable', 15),
...
(2522356, 'selsaldo', 'ivanatics', '1970-01-01', 'male', '', 'ivanatices@gmail.com', 2147483647, '', '1stvac'),
...
(2522878, 'dnko12345', '12345678', 'finder', 'disable'),
...
--
ALTER TABLE `computer_type`
  MODIFY `Ctype_id` int(55) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
