...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 11, 2022 at 07:11 PM
...
INSERT INTO `comments` (`comment_id`, `user_id`, `post_id`, `comment`, `date`, `time`) VALUES
(1, 2522878, 3, 'asdasdasa', '2004-10-22', '00:00:00'),
(2, 2522878, 3, 'sadsada', '2004-10-22', '00:00:00');
...
(1022137, 7, 'Ivan', 'Sesaldo', '', '27/4/2022', '', 'alyssamariedelgado@gmail.com', '09223334452', ''),
...
(7, 'tnc1', 'Palaez street, Cebu City', '10.298068533932295,123.89853783241296', '24/7', '100mbs', 'We are open to serve you Address: P.Del Rosario St., Cebu City Ope', '09632394707', 'tnccebuhq@gmail.com', 'Active'),
...
(13, 'sample', 'hipodromo,cebu city', '10.304005548371109,123.89671037732103', '', '', '', '09223772212', 'hackmetry01@gmail.com', 'Inactive'),
(14, 'sampleshop', 'hipodromo,cebu city', '10.303667762357932,123.89699075198456', '', '', '', '09233445673', 'hackmetry01@gmail.com', 'Inactive');
...
INSERT INTO `computer_ratings` (`rating_id`, `shop_id`, `user_id`, `computer_rate`, `date`) VALUES
(1022616, 7, 2522878, 5, '8/28/1999');
...
(4, 7, 'VIP', 10, 25, 'CPU: Intel Core i5 - 8400 @ 2.80GHz (6 CPU\'s), ~2.8 GHz', 'TNC-2.jpg', 'Available', 10),
...
(2522356, 'Delgado', 'John', '1970-01-01', 'male', '', 'hackmetry01@gmail.com', '0922377223', 'dave.jpg', 'select'),
(2522878, 'Delgado', 'John Dave', '2000-12-06', 'female', '', 'hackmetry01@gmail.com', '09262247240', 'dave2.jpg', '2ndvac'),
...
(15, 2522405, 60489, 'Message', 'asdasdasda', '04/06/22', 'unseen'),
(26, 2522356, 904780, 'Pending', 'Booking Request To be accepted by the admin', '04/09/22', 'seen'),
(27, 2522356, 604741, 'Message', 'sadfsdf', '04/06/22', 'seen'),
(28, 2522356, 304776, 'Message', 'sdafsdaf', '04/06/22', 'seen');
...
(60489, 20023332, '04/10/22', '273196427_1353761728430473_6304824051604986128_n.jpg'),
(104724, 362972601, '04/04/22', 'Untitled1.png'),
(304776, 232321, '04/05/22', 'Untitled1.png'),
(804796, 1000011, '04/09/22', 'Untitled2.png');
...
(60489, 2522878, 8, 'ComputerBooking', '22:08', '04/11/2022', 'admin', '04/06/22', 'accepted', 'waiting', 10, 'paid', 'gcash', 'qrCode-04-10-22-04-47-30.png'),
(104724, 2522878, 7, 'ComputerBooking', '16:15', '04/10/2022', 'Tapas sa Cashier', '04/01/22', 'accepted', 'waiting', 15, 'paid', 'gcash', 'not_issued'),
(104776, 2522878, 7, 'ComputerBooking', '', '04/02/2022', '', '04/01/22', 'pending', 'waiting', 15, 'unpaid', 'not_selected', 'not_issued'),
(104795, 2522878, 7, 'ComputerBooking', '20:15', '04/07/2022', 'Kilid sa Cute na Cashier<3', '04/01/22', 'accepted', 'waiting', 15, 'paid', 'gcash', 'not_issued'),
(104822, 2522878, 7, 'ComputerBooking', '02:50', '04/9/2022', 'tapad sa gwapa na cashier<3', '04/01/22', 'accepted', 'waiting', 15, 'paid', 'gcash', 'not_issued'),
(104839, 2522878, 8, 'ComputerBooking', '02:53', '04/04/2022', 'Tapda ni crush', '04/01/22', 'accepted', 'waiting', 15, 'paid', 'gcash', 'not_issued'),
(304776, 2522878, 7, 'ComputerBooking', '05:57', '04/05/2022', 'Tapas sa cute na cashier', '04/03/22', 'accepted', 'waiting', 15, 'paid', 'gcash', 'qrCode-04-05-22-04-52-18.png'),
(604741, 2522878, 7, 'ComputerBooking', '19:26', '04/07/2022', 'sd', '04/06/22', 'pending', 'waiting', 15, 'unpaid', 'not_selected', 'not_issued'),
(604817, 2522878, 8, 'ComputerBooking', '20:12', '04/12/2022', '', '04/06/22', 'accepted', 'waiting', 10, 'paid', 'overthecounter', 'qrCode-04-09-22-09-03-42.png'),
(604858, 2522878, 8, 'ComputerBooking', '19:08', '04/07/2022', '', '04/06/22', 'pending', 'waiting', 15, 'unpaid', 'not_selected', 'not_issued'),
(804796, 2522878, 7, 'ComputerBooking', '19:01', '04/09/2022', 'SuperAdmin', '04/08/22', 'accepted', 'waiting', 20, 'paid', 'gcash', 'qrCode-04-09-22-05-11-25.png'),
(904780, 2522356, 7, 'ComputerBooking', '23:51', '04/09/2022', 'asdasd', '04/09/22', 'pending', 'waiting', 15, 'unpaid', 'not_selected', 'not_issued'),
(1004726, 2522878, 7, 'ComputerBooking', '16:36', '04/11/2022', 'sadasd', '04/10/22', 'pending', 'waiting', 10, 'unpaid', 'not_selected', 'not_issued'),
(1004742, 2522878, 7, 'ComputerBooking', '18:03', '04/11/2022', 'asdfsadf', '04/10/22', 'accepted', 'waiting', 10, 'paid', 'overthecounter', 'qrCode-04-10-22-04-40-04.png'),
(1104723, 2522878, 7, 'ComputerBooking', '09:06', '04/11/2022', 'asd', '04/11/22', 'pending', 'waiting', 10, 'unpaid', 'not_selected', 'not_issued'),
(1104742, 2522878, 7, 'ComputerBooking', '16:24', '04/13/2022', 'sdsadas', '04/11/22', 'pending', 'waiting', 10, 'unpaid', 'not_selected', 'not_issued'),
(1104775, 2522878, 7, 'ComputerBooking', '16:28', '04/13/2022', 'sadas', '04/11/22', 'pending', 'waiting', 30, 'unpaid', 'not_selected', 'not_issued'),
(1104842, 2522878, 8, 'ComputerBooking', '12:04', '04/11/2022', 'asd', '04/11/22', 'pending', 'waiting', 10, 'unpaid', 'not_selected', 'not_issued');
...
(1022137, 'dave123', '12345678', 'Admin', 'Active'),
(1022388, 'dave123', '12345678', 'Admin', 'Active'),
(1022412, 'ivan123', '12345678', 'Admin', 'Active'),
...
--
ALTER TABLE `computershop`
  MODIFY `shop_id` int(33) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `computer_ratings`
--
ALTER TABLE `computer_ratings`
  MODIFY `rating_id` int(33) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1022617;
...
--
ALTER TABLE `finder_notification`
  MODIFY `finder_notif_id` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
ALTER TABLE `finder_notification`
  ADD CONSTRAINT `finder_notification_ibfk_1` FOREIGN KEY (`transaction_id`) REFERENCES `transaction` (`transaction_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `finder_notification_ibfk_2` FOREIGN KEY (`to_user_id`) REFERENCES `user` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
