			  ...
			  if($('#addadminform').valid()){
				...
				//   alert("saved");
					  ...
					  $.ajax({
						url: "registeradmin",
						type: "POST",
						data:{firstname:fname,lastname:lname,pnum:phonenum,birthdate:actbdate,username:uname,email:email,pass:pass,conpass:conpass,gender:gender,vacstatus:vacstatus,status:status},
						// contentType: false,
						//       cache: false,
						// processData:false,
						// beforeSend : function()
