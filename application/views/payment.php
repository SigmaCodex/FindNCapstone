            ...
            <div class="pt-2">
			  ...
			  <div class="d-flex flex-column mb-3">
					<div class="btn-group-vertical" role="group" aria-label="Vertical button group">
						...
						<label class="btn btn-outline-primary btn-lg"  data-toggle='modal' data-target='#AccountVerificationModal' for="option2">
...
<!-- Modal -->
<div class="modal fade" id="AccountVerificationModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
