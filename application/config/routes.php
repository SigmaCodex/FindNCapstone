...
//Logics
    ...
    $route['accept-updateBookStatus/(:num)'] = 'logicalcontroller/updateAcceptBookingTransacStatus/$1';
    $route['decline-updateBookStatus/(:num)'] = 'logicalcontroller/updateDeclineBookingTransacStatus/$1';
